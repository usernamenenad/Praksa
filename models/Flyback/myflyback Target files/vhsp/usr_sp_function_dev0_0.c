...
//////////////////////////////////////////////////////////////////////////
    ...
    _enable__out = XIo_InInt32(0x55000100);
    ...
    _pid_controller1__pi_reg_out_int = _pid_controller1__integrator_state + 1e-05 * _sum1__out;
...
//@cmp.out.block.end
    ...
    if (!_pid_controller1__av_active || ((_pid_controller1__av_active < 0 && _sum1__out > 0 ) || (_pid_controller1__av_active > 0 && _sum1__out < 0 ))) {
        _pid_controller1__integrator_state += 0.001 * _sum1__out * 0.0001;
    }
