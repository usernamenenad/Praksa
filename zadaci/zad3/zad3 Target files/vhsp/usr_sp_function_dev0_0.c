...
double _controller_open_loop_duty_ratio__out;
double _controller_reference_input_voltage__out = 12.0;
...
void ReInit_user_sp_cpu0_dev0() {
    ...
    HIL_OutInt32(0x2000080 + _buck_boost_pwm_modulator__channels[0], 14000); // divide by 2 is already implemented in hw
...
void TimerCounterHandler_0_user_sp_cpu0_dev0() {
    ...
    //////////////////////////////////////////////////////////////////////////
    // Generated from the component: Controller.Reference input voltage
...
//////////////////////////////////////////////////////////////////////////
    ...
    _controller_open_loop_duty_ratio__out = XIo_InFloat(0xfffc0004);
    ...
    _controller_sum3__out = _controller_reference_input_voltage__out - _input_voltage_sum1__out;
    ...
    _buck_boost_pwm_modulator__limited_in[0] = MIN(MAX(_controller_multiport_signal_switch1__out, 0.0), 1.0);
    HIL_OutInt32(0x2000040 + _buck_boost_pwm_modulator__channels[0], ((X_UnInt32)((_buck_boost_pwm_modulator__limited_in[0] - (0.0)) * 14000.0)));
    if (_enable_buck_boost__out == 0x0) {
        // pwm_modulator_en
    ...
    _controller_sum1__out = _controller_current_mode_controller__out - _controller_slope_compensation__out + _controller_gain__out;
