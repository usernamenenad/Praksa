...
double _compensator_pid_controller1__out;
double _compensator_pid_controller1__pi_reg_out_int;
...
double _compensator_pid_controller1__integrator_state;
X_Int32 _compensator_pid_controller1__av_active;
double _compensator_pid_controller1__filter_state;
...
//@cmp.out.block.end
    ...
    if ((_compensator_fsw__out != 0x0) && (_compensator_comparator1__out == 0x0))
        ...
        _compensator_sr_flip_flop1__state = -1;
    // Generated from the component: Compensator.Slope compensation
    _compensator_slope_compensation__current_phase += tunable_params._compensator_slope_compensation__frequency * 2e-06;
